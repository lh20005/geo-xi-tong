...
| 任务 | 状态 | 完成时间 | 备注 |
|------|------|---------|------|
| 测试文章 CRUD | ⏳ 待开始 | - | 创建、读取、更新、删除、搜索 |
| 测试知识库上传/解析 | ⏳ 待开始 | - | 文档上传、内容解析、删除 |
| 测试图库管理 | ⏳ 待开始 | - | 相册创建、图片上传、删除 |
| 测试账号登录检测 | ⏳ 待开始 | - | Cookie 验证、状态更新 |
| 测试发布任务执行 | ⏳ 待开始 | - | 单任务、批量任务 |
| 测试配额预扣减流程 | ⏳ 待开始 | - | 预扣减、确认、释放、过期 |
| 测试分析上报 | ⏳ 待开始 | - | 单条上报、批量上报、离线队列 |

### 8.2 边界测试

| 任务 | 状态 | 完成时间 | 备注 |
|------|------|---------|------|
| 测试网络中断恢复 | ⏳ 待开始 | - | 离线队列、重试机制 |
| 测试配额不足 | ⏳ 待开始 | - | 错误提示、流程中断 |
| 测试发布失败回滚 | ⏳ 待开始 | - | 配额释放、状态恢复 |
| 测试数据备份恢复 | ⏳ 待开始 | - | 快照上传、下载、恢复 |
| 测试任务超时 | ⏳ 待开始 | - | 超时检测、自动重试 |
| 测试批次停止 | ⏳ 待开始 | - | 停止信号、资源清理 |

### 8.3 性能测试

| 任务 | 状态 | 完成时间 | 备注 |
|------|------|---------|------|
| 测试 SQLite 查询性能 | ⏳ 待开始 | - | 大数据量查询（1000+ 文章） |
| 测试大文件处理 | ⏳ 待开始 | - | 知识库文档解析（10MB+） |
| 测试批量发布 | ⏳ 待开始 | - | 多任务并发（10+ 任务） |
| 测试内存占用 | ⏳ 待开始 | - | 长时间运行内存监控 |

### 8.4 集成测试

| 任务 | 状态 | 完成时间 | 备注 |
|------|------|---------|------|
| 测试完整发布流程 | ⏳ 待开始 | - | 从文章创建到发布完成 |
| 测试多平台发布 | ⏳ 待开始 | - | 同一文章发布到多个平台 |
| 测试定时发布 | ⏳ 待开始 | - | 定时任务调度 |
| 测试数据同步 | ⏳ 待开始 | - | 备份、恢复、多设备同步 |
