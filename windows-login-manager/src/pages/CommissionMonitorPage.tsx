...
const CommissionMonitorPage = () => {
  ...
  const fetchStats = useCallback(async () => {
    try {
      const response = await fetchWithAuth(`${config.apiUrl}/monitoring/commission-stats`);
      if (response.success) {
  ...
  const fetchHealth = useCallback(async () => {
    try {
      const response = await fetchWithAuth(`${config.apiUrl}/monitoring/status`);
      setHealth(response);
    } catch (error) {
  ...
  const fetchCommissions = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetchWithAuth(`${config.apiUrl}/monitoring/commissions?${params}`);
      if (response.success) {
  ...
  const fetchEvents = useCallback(async () => {
    try {
      const response = await fetchWithAuth(`${config.apiUrl}/monitoring/events?limit=50`);
  ...
  const fetchSchedulerStatus = useCallback(async () => {
    try {
      const response = await fetchWithAuth(`${config.apiUrl}/monitoring/scheduler-status`);
      if (response.success) {
  ...
  const fetchAnomalies = useCallback(async () => {
    try {
      const response = await fetchWithAuth(`${config.apiUrl}/monitoring/commission-anomalies`);
  ...
  const fetchAgents = useCallback(async () => {
    try {
      const response = await fetchWithAuth(`${config.apiUrl}/monitoring/agents`);
      if (response.success) {
  ...
  const columns = [
    ...
    { 
      ...
      render: (_: any, record: CommissionRecord) => {
        ...
        const cfg = map[record.profitSharingStatus] || { color: 'default', text: record.profitSharingStatus };
