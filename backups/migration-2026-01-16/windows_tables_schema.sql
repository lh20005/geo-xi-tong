...
ALTER TABLE ONLY public.article_settings
    ADD CONSTRAINT article_settings_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.conversion_targets
    ADD CONSTRAINT conversion_targets_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.distillation_config
    ADD CONSTRAINT distillation_config_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.distillations
    ADD CONSTRAINT distillations_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.publishing_records
    ADD CONSTRAINT fk_publishing_records_user FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.publishing_records
    ADD CONSTRAINT publishing_records_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.publishing_tasks
    ADD CONSTRAINT publishing_tasks_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
