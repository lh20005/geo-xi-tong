...
const publicKeyId = 'PUB_KEY_ID_0111039601042025122900292089000201';
...
[PaymentService] 使用公钥模式，公钥ID: PUB_KEY_ID_0111039601042025122900292089000201
✅ 微信支付初始化成功（公钥模式）
```
...
当前使用的公钥 ID：
```
PUB_KEY_ID_0111039601042025122900292089000201
```
